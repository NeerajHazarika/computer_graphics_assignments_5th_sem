...
public class test extends Applet implements ActionListener
{
	...
	{  
		...
		rectangle_x = rectangle_x*scale - (rectangle_size_multiplier*scale)/2; // shifting x coordinate to draw shapes on applet coordinate
		rectangle_y = rectangle_y*scale + (rectangle_size_multiplier*scale)/2; // shifting y coordinate to draw shapes on applet coordinate
		g.setColor(Color.red);
		g.drawRect(originX+rectangle_x,originY-rectangle_y,scale*rectangle_size_multiplier,scale*rectangle_size_multiplier);		
		g.fillRect(originX+rectangle_x,originY-rectangle_y,scale*rectangle_size_multiplier,scale*rectangle_size_multiplier);
	}
